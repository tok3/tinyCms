...
return [
    ...
    | wie die Größenregeln. Fühlen Sie sich frei, jede dieser Nachrichten hier anzupassen.
    |
    */
    ...
    | indem Sie die Konvention "attribute.rule" zur Benennung der Zeilen verwenden. Dies macht es schnell,
    | eine spezifische benutzerdefinierte Sprachzeile für eine bestimmte Attributregel anzugeben.
    |
    */
    ...
    | mit etwas leserfreundlicherem zu tauschen, wie z.B. "E-Mail-Adresse" statt
    | "email". Dies hilft uns einfach, unsere Nachricht ausdrucksstärker zu machen.
    |
    */
