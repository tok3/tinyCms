<x-assan-layout layout-type="{{$layoutType}}">
            <section class="position-relative bg-primary-subtle">
                <div class="container position-relative py-9 py-lg-11">
                    <div class="row">
                        <div class="col-xl-9">
                            <h1 class="display-4 mb-3">Header Offcanvas Collapse</h1>
    ...
    &lt;nav class="navbar navbar-expand-lg navbar-light">
        &lt;div class="container position-relative">
            ...
            &lt;div class="d-flex align-items-center navbar-no-collapse-items order-lg-last">
                ...
                &lt;/div>
            &lt;/div>
            &lt;div class="offcanvas-lg offcanvas-navbar offcanvas-start" id="mainNavbarTheme">
                &lt;!--Offcanvas collapse close button-->
                &lt;div class="offcanvas-header justify-content-end p-0">
                    &lt;button class="btn btn-secondary px-2 py-1 rounded-top-end-0" data-bs-target="#mainNavbarTheme"
