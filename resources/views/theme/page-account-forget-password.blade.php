<x-assan-layout layout-type="{{$layoutType}}">
            ...
            <section class="position-relative d-flex justify-content-center h-100">
                <div class="bg-dark d-none d-md-flex position-fixed end-0 top-0 w-md-50 w-lg-60 h-100">
                    ...
                    <!--Image-->
                    <img src="{{ URL::asset('assets/img/backgrounds/bg7.jpg') }}" alt="" class="bg-image">
                </div>
                               ...
                               <a class="navbar-brand" href="{{ URL::asset('index.html') }}">
                                ...
                                <div>
                                    <form class="needs-validation" novalidate>
                                        <div class="mb-3">
                                            <input type="email" required class="form-control" id="username" autofocus
                                                placeholder="Enter registered email id or phone">
                                        </div>
