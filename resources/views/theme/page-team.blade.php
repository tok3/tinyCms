<x-assan-layout layout-type="{{$layoutType}}">
            <section class="position-relative bg-gradient-primary text-white jarallax" data-speed=".2">
                <img src="{{ URL::asset('assets/img/backgrounds/bg2.jpg') }}" class="jarallax-img" alt="">
                ...
                <div class="container position-relative z-2 pt-12 pb-12">
                    <div class="row pb-9 pb-lg-12 pt-lg-12">
                           <div class="col-12 col-xl-10">
                               <h1 class="display-4 mb-3">Meet our challengers</h1>
                            <p class="mb-0">With our dedicated team of highly skilled, we deliver quality on time </p>
                           </div>
                        </div>
                    </div>
                    <!--/.container-->
                ...
                <div class="container py-9 py-lg-11">
                    <div class="row mb-7">
                        <div class="col-lg-4 mb-7 mt-auto text-center" data-aos="fade-up" data-aos-delay="100" data-aos-duration="700">
                            <div class="position-relative mb-4 overflow-hidden card-hover rounded-4">
                                <img src="{{ URL::asset('assets/img/team/1.jpg') }}" alt="" class="img-fluid img-zoom rounded-4">
                            </div>
                            ...
                            <div>
                                ...
                                <p class="d-block mb-3">Creative director</p>
                        ...
                        <div class="col-lg-4 mb-7 mt-auto text-center" data-aos="fade-up" data-aos-delay="100" data-aos-duration="700">
                            <div class="position-relative mb-4 overflow-hidden card-hover rounded-4">
                                <img src="{{ URL::asset('assets/img/team/2.jpg') }}" alt="" class="img-fluid img-zoom rounded-4">
                            </div>
                            <div>
                                <h5 class="mb-1 text-primary">
                                    Olive Mathews
                                </h5>
                                <p class="d-block mb-3">Visual designer</p>
                                <p class="w-lg-75 mx-auto mb-2">
                                    Duis aute irure dolor in velit esse cillum fugiat nulla pariatur.
                                </p>
                        ...
                        <div class="col-lg-4 mb-7 mt-auto text-center" data-aos="fade-up" data-aos-delay="100" data-aos-duration="700">
                            <div class="position-relative mb-4 overflow-hidden card-hover rounded-4">
                                <img src="{{ URL::asset('assets/img/team/3.jpg') }}" alt="" class="img-fluid img-zoom rounded-4">
                            </div>
                            <div>
                                <h5 class="mb-1 text-primary">
                                    Aarav Lynn
                                </h5>
                                <p class="d-block mb-3">Developer</p>
                                <p class="w-lg-75 mx-auto mb-2">
                                    Duis aute irure dolor in velit esse cillum fugiat nulla pariatur.
                                </p>
                        ...
                        <div class="py-4"></div>
                        <div class="col-lg-4 mb-7 text-center" data-aos="fade-up" data-aos-delay="100" data-aos-duration="700">
                            <div class="position-relative mb-4 overflow-hidden card-hover rounded-4">
                                <img src="{{ URL::asset('assets/img/team/5.jpg') }}" alt="" class="img-fluid img-zoom rounded-4">
                            </div>
                            <div>
                                <h5 class="mb-1 text-primary">
                                    Eva Calvert
                                </h5>
                                <p class="d-block mb-3">Motion designer</p>
                                <p class="w-lg-75 mx-auto mb-2">
                                    Duis aute irure dolor in velit esse cillum fugiat nulla pariatur.
                                </p>
                        ...
                        <div class="col-lg-4 mb-7 text-center" data-aos="fade-up" data-aos-delay="100" data-aos-duration="700">
                            <div class="position-relative mb-4 overflow-hidden card-hover rounded-4">
                                <img src="{{ URL::asset('assets/img/team/6.jpg') }}" alt="" class="img-fluid img-zoom rounded-4">
                            </div>
                            <div>
                                <h5 class="mb-1 text-primary">
                                    Amiya Potts
                                </h5>
                                <p class="d-block mb-3">Strategist / Copywriter</p>
                                <p class="w-lg-75 mx-auto mb-2">
                                    Duis aute irure dolor in velit esse cillum fugiat nulla pariatur.
                                </p>
                        ...
                        <div class="col-lg-4 mb-7" data-aos="fade-up" data-aos-delay="250" data-aos-duration="700">
                            <div class="position-relative d-flex flex-column h-100">
                               <div class="position-relative rounded-4 mb-4 w-100 bg-gradient-primary">
                                <img src="{{ URL::asset('assets/img/team/1.jpg') }}" class="img-fluid rounded-4 opacity-0" alt="">
                                <div class="h-100 w-100 d-flex align-items-center justify-content-center fs-1 text-white position-absolute start-0 top-0">
                               ...
                               <div class="w-100 text-center">
                                <h4 class="mb-1">
                                  ...
                                  <p class="d-block">Become a member of our super team</p>
                                  
                                <div class="d-grid">
                                    <a href="{{ URL::asset('#!') }}" class="btn btn-secondary">View Job Openings
                                        <i class="bx bx-right-arrow-alt fs-5 align-middle lh-1"></i>
                                    </a>
                                </div>
                                </div>
                            </div>
                    ...
                    <div class="row pt-9">
                        <div class="col-lg-10 col-xl-9 mx-auto" data-aos="fade-up" data-aos-delay="100" data-aos-duration="700">
                            <div class="position-relative">
                                <h1 class="display-4 font-serif mb-5 text-center">
                                    " Great things in
