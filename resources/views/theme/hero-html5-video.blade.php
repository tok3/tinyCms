<x-assan-layout layout-type="{{$layoutType}}">
            ...
            <section class="bg-gradient-primary text-white position-relative overflow-hidden">
                 <!--:Video:-->
                 <div class="w-100 h-100 opacity-25 position-absolute end-0 top-0 bg-cover bg-no-repeat bg-center" style="background-image: {{ URL::asset('assets/videos/officeloop-cover.jpg') }};">
                    <div class="jarallax bg-dark h-100 w-100" data-video-src="{{ URL::asset('mp4:./assets/videos/officeloop.mp4') }}">
                    </div>
                </div>
                    ...
                    <div class="row pt-7 align-items-center">
                        <div class="col-lg-10 col-xl-8 mx-auto text-center mb-5 mb-lg-0">
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                                <a href="{{ URL::asset('#section') }}" class="btn btn-outline-white border-2 btn-lg px-4 px-lg-5">Let's get started</a>
                            </div>
                        </div>
                    </div>
                </div>
