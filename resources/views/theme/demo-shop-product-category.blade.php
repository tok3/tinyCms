<x-assan-layout layout-type="{{$layoutType}}">
          ...
          <div class="py-8 py-lg-11 bg-dark text-white position-relative">
            ...
            <div class="row align-items-center position-relative">
              <div class="col-lg-10 mx-auto text-center">
                ...
                <h1 class="mb-0 display-3">Shoes & Sandals
                </h1>
              </div>
            </div>
            <!--/.row-->
      ...
      <section class="position-relative">
        <div class="container pt-3 pb-7 pb-lg-9 position-relative">
            ...
            <div class="col-md-10 mx-auto pt-5">
              ...
              <div class="row mb-5 align-items-center">
                <div class="col-5 col-md-3 mb-3 mb-md-0">
                  <a href="{{ URL::asset('#shop_filters') }}" data-bs-toggle="collapse" aria-expanded="false" class="btn btn-light btn-sm">
                    <i class="bx bx-filter fs-5"></i> Filter
                  </a>
                </div>
                <div class="col-7 text-end col-md-5 mb-3 mb-md-0">
              ...
              <div class="collapse" id="shop_filters">
                <div class="row">
                  ...
                  <div class="col-sm-6 col-xl-3">
                    ...
                    <div class="card p-0 overflow-hidden card-body mb-4">
                      ...
                      <div class="d-flex p-3 border-bottom align-items-center">
                        ...
                        <div class="pt-1 flex-grow-1 bg-body-secondary"></div>
                      </div>
                      <!--:Collapse categories-->
                        ...
                        <ul class="list-unstyled mb-0">
                          <li class="btn-group mb-2">
                            <div class="d-flex flex-wrap gap-1" role="group"
                              ...
                              <label
                                class="shop-product-color btn p-0 border-0 me-1 width-2x height-2x flex-center rounded-circle text-white product-black"
                                for="color_black"></label>
                              <input type="checkbox" class="btn-check" name="btnradio" id="color_blue">
                              <label
                                class="shop-product-color btn p-0 border-0 me-1 width-2x height-2x flex-center rounded-circle text-white product-blue"
                              ...
                              <label
                                class="shop-product-color btn p-0 border-0 me-1 width-2x height-2x flex-center rounded-circle text-dark product-yellow"
                                for="color_yellow"></label>
                              <input type="checkbox" class="btn-check" name="btnradio" id="color_pink">
                              <label
                                class="shop-product-color btn p-0 border-0 me-1 width-2x height-2x flex-center rounded-circle text-dark product-pink"
                                for="color_pink"></label>
                              <input type="checkbox" class="btn-check" name="btnradio" id="color_purple">
                              <label
                                class="shop-product-color btn p-0 border-0 me-1 width-2x height-2x flex-center rounded-circle text-white product-purple"
                                for="color_purple"></label>

                              <input type="checkbox" class="btn-check" name="btnradio" id="color_white">
                              <label
                                class="shop-product-color shadow-sm btn p-0 border-0 me-1 width-2x height-2x flex-center rounded-circle text-dark border product-white"
                  ...
                  <div class="col-sm-6 col-xl-3">
                    ...
                    <div class="card overflow-hidden p-0 mb-4 card-body">
                      ...
                      <!--:list-->
                      <ul class="list-unstyled px-3 pt-3 pb-2 mb-0" data-simplebar style="max-height: 13rem;">
                        ...
                        <li class="widget-filter-item d-flex justify-content-between align-items-center mb-1">
                          <div class="form-check">
                            ...
                            <label class="form-check-label widget-filter-item-text" for="birkenstock">Allen
                              Solly</label>
                  ...
                  <div class="col-sm-6 col-xl-3">
                    ...
                    <div class="card overflow-hidden p-0 mb-4 card-body">
                      <!--:Title-->
                      <div class="d-flex p-3 border-bottom align-items-center">
                        <h6 class="me-3 mb-0">Size</h6>
                        <div class="pt-1 flex-grow-1 bg-body-secondary"></div>
                      </div>
                      <!--:list-->
                      <ul class="list-unstyled mb-0 pb-2 pt-3 px-3" data-simplebar style="max-height: 13rem;">
                        <li class="widget-filter-item d-flex justify-content-between align-items-center mb-1">
                          <div class="form-check">
                      ...
                      <div class="p-3 pt-0">
                        <ul class="list-unstyled mb-0">
                          <li class="form-check mb-2">
                            <input type="radio" name="byPrice" class="form-check-input" id="range_level_1">
                            <label for="range_level_1" class="form-check-label">$100 -
                              $1000</label>
                          </li>
                          <li class="form-check mb-2">
                            <input type="radio" name="byPrice" class="form-check-input" id="range_level_2">
                            <label for="range_level_2" class="form-check-label">$1000 -
                              $2500</label>
                          </li>
                          <li class="form-check mb-2">
                            <input type="radio" name="byPrice" class="form-check-input" id="range_level_3">
                            <label for="range_level_3" class="form-check-label">$2500 -
                              $5000</label>
                          </li>
                          <li class="form-check">
                            <input type="radio" name="byPrice" class="form-check-input" id="range_level_4">
                            <label for="range_level_4" class="form-check-label">$5000 -
                              $10000</label>
                          </li>
                        </ul>
                      </div>
                ...
                <div class="text-end">
                  <a href="{{ URL::asset('#!') }}" class="btn btn-primary me-3">Apply</a>
                  <a href="{{ URL::asset('#!') }}" class="btn btn-outline-gray-200 text-body">Clear</a>
                </div>
                <hr>
              </div>
              ...
              <div class="row mb-5">
                <div class="col-md-6 col-xl-4 mb-4">
                  ...
                  <div class="card overflow-hidden hover-lift card-product">
                    <div class="card-product-header p-3 d-block overflow-hidden position-relative">
                      <a href="{{ URL::asset('#!') }}">
                        <img src="{{ URL::asset('assets/img/shop/category/01.jpg') }}" class="img-fluid rounded" alt="Product">
                      </a>
                    </div>
                ...
                <div class="col-md-6 col-xl-4 mb-4">
                  ...
                  <div class="card overflow-hidden hover-lift card-product">
                    <div class="card-product-header p-3 d-block overflow-hidden position-relative">
                      <a href="{{ URL::asset('#!') }}">
                        <img src="{{ URL::asset('assets/img/shop/category/02.jpg') }}" class="img-fluid rounded" alt="Product">
                      </a>
                ...
                <div class="col-md-6 col-xl-4 mb-4">
                  ...
                  <div class="card overflow-hidden hover-lift card-product">
                    <div class="card-product-header p-3 d-block overflow-hidden position-relative">
                      <a href="{{ URL::asset('#!') }}">
                        <img src="{{ URL::asset('assets/img/shop/category/03.jpg') }}" class="img-fluid rounded" alt="Product">
                      </a>
                    </div>
                    <div class="card-product-body p-3 pt-0 text-center">
                      <a href="{{ URL::asset('#!') }}" class="fs-5 fw-semibold d-block position-relative mb-2">Product Title</a>
                ...
                <div class="col-md-6 col-xl-4 mb-4">
                  ...
                  <div class="card overflow-hidden hover-lift card-product">
                    <div class="card-product-header p-3 d-block overflow-hidden position-relative">
                      <a href="{{ URL::asset('#!') }}">
                        <img src="{{ URL::asset('assets/img/shop/category/04.jpg') }}" class="img-fluid rounded" alt="Product">
                      </a>
                ...
                <div class="col-md-6 col-xl-4 mb-4">
                  ...
                  <div class="card overflow-hidden hover-lift card-product">
                    <div class="card-product-header p-3 d-block overflow-hidden position-relative">
                      <a href="{{ URL::asset('#!') }}">
                        <img src="{{ URL::asset('assets/img/shop/category/05.jpg') }}" class="img-fluid rounded" alt="Product">
                      </a>
                    </div>
                    <div class="card-product-body p-3 pt-0 text-center">
                      <a href="{{ URL::asset('#!') }}" class="fs-5 fw-semibold d-block position-relative mb-2">Product Title</a>
                ...
                <div class="col-md-6 col-xl-4 mb-4">
                  ...
                  <div class="card overflow-hidden hover-lift card-product">
                    <div class="card-product-header p-3 d-block overflow-hidden position-relative">
                      <a href="{{ URL::asset('#!') }}">
                        <img src="{{ URL::asset('assets/img/shop/category/06.jpg') }}" class="img-fluid rounded" alt="Product">
                      </a>
                ...
                <div class="col-md-12 mb-4">
                  <div class="position-relative vh-50 rounded overflow-hidden">
                    ...
                    <div
                      ...
                      <div>
                        <h2 class="mb-0 display-5 text-dark">Pink Color Sneakers</h2>
                ...
                <div class="col-md-6 col-xl-4 mb-4">
                  ...
                  <div class="card overflow-hidden hover-lift card-product">
                    <div class="card-product-header p-3 d-block overflow-hidden position-relative">
                      <a href="{{ URL::asset('#!') }}">
                        <img src="{{ URL::asset('assets/img/shop/category/07.jpg') }}" class="img-fluid rounded" alt="Product">
                      </a>
                    </div>
                    <div class="card-product-body p-3 pt-0 text-center">
                      <a href="{{ URL::asset('#!') }}" class="fs-5 fw-semibold d-block position-relative mb-2">Product Title</a>
                ...
                <div class="col-md-6 col-xl-4 mb-4">
                  ...
                  <div class="card overflow-hidden hover-lift card-product">
                    <div class="card-product-header p-3 d-block overflow-hidden position-relative">
                      <a href="{{ URL::asset('#!') }}">
                        <img src="{{ URL::asset('assets/img/shop/category/08.jpg') }}" class="img-fluid rounded" alt="Product">
                      </a>
                ...
                <div class="col-md-6 col-xl-4 mb-4">
                  ...
                  <div class="card overflow-hidden hover-lift card-product">
                    <div class="card-product-header p-3 d-block overflow-hidden position-relative">
                      <a href="{{ URL::asset('#!') }}">
                        <img src="{{ URL::asset('assets/img/shop/category/09.jpg') }}" class="img-fluid rounded" alt="Product">
                      </a>
                    </div>
                    <div class="card-product-body p-3 pt-0 text-center">
                      <a href="{{ URL::asset('#!') }}" class="fs-5 fw-semibold d-block position-relative mb-2">Product Title</a>
