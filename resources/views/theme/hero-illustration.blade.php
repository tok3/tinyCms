<x-assan-layout layout-type="{{$layoutType}}">
            <!--::Start Page Hero Illustration::-->
            <section class="position-relative bg-gradient-blur">
                <div class="container pt-12 pt-lg-15 pb-7">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-md-6 mb-5 mb-md-0">
                            <!--:Heading:-->
                            <h1 class="display-2 mb-3 mb-lg-4">Write less.<br>Do More.</h1>
                            <!--:Subheading:-->
                            <p class="mb-5 w-lg-75 lead">
                                Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt
                                mollit anim id est laborum.
                            </p>
                            <!--:Action:-->
                            <a href="{{ URL::asset('#') }}" class="btn btn-hover-arrow btn-primary hover-lift"><span>Get started</span></a>
                        </div>
                        <div class="col-md-6 mx-auto mx-md-0">
                            <div class="position-relative">
                                <!--:Illustration:-->
                                <img src="{{ URL::asset('assets/img/graphics/illustration/06.svg') }}"
                                    class="img-fluid position-relative w-100 mx-auto d-block" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            </section>
            <!--::/End Page Hero Illustration::-->
