                    ...
                    <div class="row pt-lg-7">
                        <div class="col-lg-7">
                            <ol class="breadcrumb mb-3">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">grid overlay 4 columns</li>
                            </ol>
                ...
                <div class="container-fluid py-9 py-lg-11 position-relative z-1">
                    ...
                    <ul class="mb-5 nav nav-pills d-inline-flex align-items-center mb-0">
                      ...
                      <div id="projects" data-isotope='{"layoutMode": "masonry"}' class="row g-2">
                        ...
                        <div class="col-md-6 col-lg-3 development grid-item">
                                ...
                                <div class="card-hover-2-overlay position-absolute start-0 top-0 w-100 h-100 d-flex px-4 py-5 flex-column justify-content-between">
                                    <div class="card-hover-2-header w-100">
                                        <div class="card-hover-2-title">
                                            <h5 class="fs-5 mb-2">Mirror Website</h5>
                                        </div>
                                        <p class="mb-0">
                        ...
                        <div class="col-md-6 col-lg-3 motion grid-item">
                            <a href="{{ URL::asset('#!') }}" class="text-white bg-dark position-relative d-block overflow-hidden card-hover-2">
                                <img src="{{ URL::asset('assets/img/projects/5.jpg') }}" alt="" class="w-100 img-zoom">
                                <div class="card-hover-2-overlay position-absolute start-0 top-0 w-100 h-100 d-flex px-4 py-5 flex-column justify-content-between">
                                    <div class="card-hover-2-header w-100">
                                        <div class="card-hover-2-title">
                                            <h5 class="fs-5 mb-2">Excepteur sint occaecat Branding</h5>
                                        </div>
                                        <p class="mb-0">
                                           Lorem lipsum dolor sit amet...
                                        </p>
                        ...
                        <div class="col-md-6 col-lg-3 motion grid-item">
                            <a href="{{ URL::asset('#!') }}" class="text-white bg-dark position-relative d-block overflow-hidden card-hover-2">
                                ...
                                <div class="card-hover-2-overlay position-absolute start-0 top-0 w-100 h-100 d-flex px-4 py-5 flex-column justify-content-between">
                                    <div class="card-hover-2-header w-100">
                                        <div class="card-hover-2-title">
                                            <h5 class="fs-5 mb-2">3D Illustrations</h5>
                                        </div>
                                        <p class="mb-0">
                                           Lorem lipsum dolor sit amet...
                                        </p>
                        ...
                        <div class="col-md-6 col-lg-3 design development grid-item">
                            <a href="{{ URL::asset('#!') }}" class="text-white bg-dark position-relative d-block overflow-hidden card-hover-2">
                                <img src="{{ URL::asset('assets/img/projects/2.jpg') }}" alt="" class="w-100 img-zoom">
                                <div class="card-hover-2-overlay position-absolute start-0 top-0 w-100 h-100 d-flex px-4 py-5 flex-column justify-content-between">
                                    <div class="card-hover-2-header w-100">
                                        <div class="card-hover-2-title">
                                            <h5 class="fs-5 mb-2">Skarta Design & Development</h5>
                                        </div>
                                        <p class="mb-0">
                                           Lorem lipsum dolor sit amet...
                                        </p>
                        ...
                        <div class="col-md-6 col-lg-3 motion grid-item">
                            <a href="{{ URL::asset('#!') }}" class="text-white bg-dark position-relative d-block overflow-hidden card-hover-2">
                                ...
                                <div class="card-hover-2-overlay position-absolute start-0 top-0 w-100 h-100 d-flex px-4 py-5 flex-column justify-content-between">
                                    <div class="card-hover-2-header w-100">
                                        <div class="card-hover-2-title">
                                            <h5 class="fs-5 mb-2">Illustration Design</h5>
                                        </div>
                                        <p class="mb-0">
                                           Lorem lipsum dolor sit amet...
                                        </p>
                        ...
                        <div class="col-md-6 col-lg-3 design grid-item">
                            <a href="{{ URL::asset('#!') }}" class="text-white bg-dark position-relative d-block overflow-hidden card-hover-2">
                                <img src="{{ URL::asset('assets/img/projects/4.jpg') }}" alt="" class="w-100 img-zoom">
                                <div class="card-hover-2-overlay position-absolute start-0 top-0 w-100 h-100 d-flex px-4 py-5 flex-column justify-content-between">
                                    <div class="card-hover-2-header w-100">
                                        <div class="card-hover-2-title">
                                            <h5 class="fs-5 mb-2">Formaty Website Design</h5>
                                        </div>
                                        <p class="mb-0">
                                           Lorem lipsum dolor sit amet...
                                        </p>
