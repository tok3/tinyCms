<x-assan-layout layout-type="{{$layoutType}}">
            <section class="position-relative bg-primary bg-gradient text-white">
                <div class="container position-relative pt-12 pb-9 pb-lg-12">
                    <div class="row pt-9 pt-lg-14">
                        <div class="col-xl-9">
                            <h1 class="display-4 mb-3">Header Info bar 2</h1>
                ...
                &lt;div class="col-5">
                    ...
                    &lt;ul class="list-inline mb-0">
                        &lt;li class="list-inline-item me-0">
                            &lt;a href="{{ URL::asset('#!') }}" class="d-inline-block si rounded-pill width-2x height-2x si-hover-facebook">
                                &lt;i class="bx bxl-facebook fs-6">&lt;/i>
                                &lt;i class="bx bxl-facebook fs-6">&lt;/i>
                            &lt;/a>
                        &lt;/li>
                        &lt;li class="list-inline-item me-0">
                            &lt;a href="{{ URL::asset('#!') }}" class="d-inline-block si rounded-pill width-2x height-2x si-hover-twitter">
                                &lt;i class="bx bxl-twitter fs-6">&lt;/i>
                                &lt;i class="bx bxl-twitter fs-6">&lt;/i>
                            &lt;/a>
                        &lt;/li>
                        &lt;li class="list-inline-item">
                            &lt;a href="{{ URL::asset('#!') }}" class="d-inline-block si rounded-pill width-2x height-2x si-hover-linkedin">
                ...
                &lt;div class="col-7 text-end">
                    &lt;div class="d-flex align-items-center justify-content-end">
                        ...
                        &lt;span class="me-3 small">
                            &lt;i class="bx bx-phone me-2 align-middle text-white-50 d-none d-md-inline-block">&lt;/i>+01
                            555 1234 789
                        &lt;/span>
                        &lt;a href="{{ URL::asset('#') }}" class="small text-white">
                            &lt;i
                                class="bx bx-user-circle me-2 align-middle d-none d-md-inline-block text-white-50">&lt;/i>Login&lt;/a>
                    &lt;/div>
                &lt;/div>
            &lt;/div>
        &lt;/div>
