                    ...
                    <div class="row pt-lg-7">
                        <div class="col-lg-7">
                            <ol class="breadcrumb mb-3">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">grid full-width 4 columns</li>
                            </ol>
            ...
            <section class="position-relative">
                ...
                <div class="container-fluid px-0 position-relative z-1">
                    <div id="projects" data-isotope='{"layoutMode": "masonry"}' class="row g-0">
                        ...
                        <div class="col-md-6 col-xl-3 development grid-item">
                        ...
                        <div class="col-md-6 col-xl-3 motion grid-item">
                            <a href="{{ URL::asset('#!') }}" class="card-over card-split-hover d-block card-hover overflow-hidden">
                                <img src="{{ URL::asset('assets/img/projects/2.jpg') }}" alt="" class="img-fluid img-zoom">
                                <div class="card-overlay p-4 p-lg-5 d-flex align-items-end text-white">
                                    <ul class="list-unstyled overlay-items">
                                        <li>
                                            <h5 class="mb-2 fs-4 splitting-up" data-splitting>Awesome title</h5>
                        ...
                        <div class="col-md-6 col-xl-3 design development grid-item">
                            <a href="{{ URL::asset('#!') }}" class="card-over card-split-hover d-block card-hover overflow-hidden">
                        ...
                        <div class="col-md-6 col-xl-3 design grid-item">
                            <a href="{{ URL::asset('#!') }}" class="card-over card-split-hover d-block card-hover overflow-hidden">
                                <img src="{{ URL::asset('assets/img/projects/6.jpg') }}" alt="" class="img-fluid img-zoom">
                                <div class="card-overlay p-4 p-lg-5 d-flex align-items-end text-white">
                                    <ul class="list-unstyled overlay-items">
                                        <li>
                                            <h5 class="mb-2 fs-4 splitting-up" data-splitting>Awesome title</h5>
                        ...
                        <div class="col-md-6 col-xl-3 development grid-item">
                            <a href="{{ URL::asset('#!') }}" class="card-over card-split-hover d-block card-hover overflow-hidden">
                                <img src="{{ URL::asset('assets/img/projects/7.jpg') }}" alt="" class="img-fluid img-zoom">
                                <div class="card-overlay p-4 p-lg-5 d-flex align-items-end text-white">
                                    <ul class="list-unstyled overlay-items">
                                        <li>
                                            <h5 class="mb-2 fs-4 splitting-up" data-splitting>Awesome title</h5>
                        ...
                        <div class="col-md-6 col-xl-3 design grid-item">
                            <a href="{{ URL::asset('#!') }}" class="card-over card-split-hover d-block card-hover overflow-hidden">
                                <img src="{{ URL::asset('assets/img/projects/8.jpg') }}" alt="" class="img-fluid img-zoom">
                                <div class="card-overlay p-4 p-lg-5 d-flex align-items-end text-white">
                                    <ul class="list-unstyled overlay-items">
                                        <li>
                                            <h5 class="mb-2 fs-4 splitting-up" data-splitting>Awesome title</h5>
