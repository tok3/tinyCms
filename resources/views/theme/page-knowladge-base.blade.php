                    ...
                    <div class="row pt-lg-6">
                        <div class="col-md-10 col-xl-7 mx-auto text-center">
                            ...
                            <div class="d-flex justify-content-center align-items-center flex-wrap pt-4">
                                ...
                                <a href="{{ URL::asset('#!') }}" class="badge bg-secondary-subtle border text-body me-2 mb-2">Sass</a>
                                <a href="{{ URL::asset('#!') }}" class="badge bg-secondary-subtle border text-body me-2 mb-2">Babel</a>
                                <a href="{{ URL::asset('#!') }}" class="badge bg-secondary-subtle border text-body me-2 mb-2">Javascript</a>
                                <a href="{{ URL::asset('#!') }}" class="badge bg-secondary-subtle border text-body me-2 mb-2">Animations</a>
                            </div>
                        </div>
                    </div>
                    <!--/.row-->
                ...
                <div class="container pt-7 pt-lg-9 pb-9 pb-lg-11">
                    <div class="row justify-content-between">
                        <div class="col-md-8 mb-5 mb-md-0">
                            ...
                            <!--Topic item-->
                            <a class="px-3 py-4 mb-3 border hover-shadow-lg rounded-3 hover-lift d-flex text-body" href="{{ URL::asset('#!') }}">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="avatar-group">
                                            <div class="avatar-group-item avatar xs rounded-circle overflow-hidden">
                                                <img src="{{ URL::asset('assets/img/avatar/1.jpg') }}" alt="" class="img-fluid">
                                            </div>
                                            <div class="avatar-group-item avatar xs rounded-circle overflow-hidden">
                                                <img src="{{ URL::asset('assets/img/avatar/2.jpg') }}" alt="" class="img-fluid">
                                            </div>
                                            <div class="avatar-group-item avatar xs rounded-circle overflow-hidden">
                                                <img src="{{ URL::asset('assets/img/avatar/3.jpg') }}" alt="" class="img-fluid">
                                            </div>
                            ...
                            <a class="px-3 py-4 mb-3 border hover-shadow-lg rounded-3 hover-lift d-flex text-body" href="{{ URL::asset('#!') }}">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="avatar-group">
                                            <div class="avatar-group-item avatar xs rounded-circle overflow-hidden">
                                                <img src="{{ URL::asset('assets/img/avatar/9.jpg') }}" alt="" class="img-fluid">
                                            </div>
                                            <div class="avatar-group-item avatar xs rounded-circle overflow-hidden">
                                                <img src="{{ URL::asset('assets/img/avatar/8.jpg') }}" alt="" class="img-fluid">
                                            </div>
                                            <div class="avatar-group-item avatar xs rounded-circle overflow-hidden">
                                                <img src="{{ URL::asset('assets/img/avatar/7.jpg') }}" alt="" class="img-fluid">
                                            </div>
                                            <div class="avatar-group-item avatar xs rounded-circle overflow-hidden">
                                                <img src="{{ URL::asset('assets/img/avatar/6.jpg') }}" alt="" class="img-fluid">
                                            </div>
                                            <div class="avatar-group-item avatar xs flex-center rounded-circle overflow-hidden">
                                                <i class="bx bx-plus"></i>
                                            </div>
                            ...
                            <a class="px-3 py-4 mb-3 border hover-shadow-lg rounded-3 hover-lift d-flex text-body" href="{{ URL::asset('#!') }}">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="avatar-group">
                                            <div class="avatar-group-item avatar xs rounded-circle overflow-hidden">
                                                <img src="{{ URL::asset('assets/img/avatar/4.jpg') }}" alt="" class="img-fluid">
                                            </div>
                                            <div class="avatar-group-item avatar xs rounded-circle overflow-hidden">
                                                <img src="{{ URL::asset('assets/img/avatar/5.jpg') }}" alt="" class="img-fluid">
                                            </div>
                                            <div class="avatar-group-item avatar xs flex-center rounded-circle overflow-hidden">
                                                <i class="bx bx-plus"></i>
                                            </div>
                        ...
                        <div class="col-md-4 col-xl-3">
                            <div class="sticky-top top-0 pt-3">
                                <div class="card card-body py-5 px-4 shadow-lg rounded-3">
                                    <a href="{{ URL::asset('mailto:your@mail.com') }}" class="d-table">
                                    ...
                                    <nav class="mb-0">
                                        <a href="{{ URL::asset('#') }}" class="badge border text-body rounded-pill mb-1">Javascript</a>
                                        <a href="{{ URL::asset('#') }}" class="badge border text-body rounded-pill mb-1">Animations</a>
                                        <a href="{{ URL::asset('#') }}" class="badge border text-body rounded-pill mb-1">Lightbox</a>
                                        <a href="{{ URL::asset('#') }}" class="badge border text-body rounded-pill mb-1">Icons</a>
                                        <a href="{{ URL::asset('#') }}" class="badge border text-body rounded-pill mb-1">Modal</a>
                                        <a href="{{ URL::asset('#') }}" class="badge border text-body rounded-pill mb-1">Dropdown</a>
                                        <a href="{{ URL::asset('#') }}" class="badge border text-body rounded-pill mb-1">Hover</a>
                                        <a href="{{ URL::asset('#') }}" class="badge border text-body rounded-pill mb-1">Splitting</a>
                                        <a href="{{ URL::asset('#') }}" class="badge border text-body rounded-pill mb-1">Javascript</a>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 col-xl-3 mb-4 mb-md-0">
                            <a href="{{ URL::asset('#!') }}"
                                ...
                                <div class="position-relative">
                                    <!--Icon-->
                                    <img src="{{ URL::asset('assets/img/graphics/icons/help.svg') }}" data-inject-svg class="img-fluid width-5x h-auto mb-5 fill-primary">
                                    <!--Content-->
                        ...
                        <div class="col-md-4 col-xl-3 mb-4 mb-md-0">
                            <a href="{{ URL::asset('#!') }}"
                                ...
                                <div class="position-relative">
                                    <!--Icon-->
                                   <img src="{{ URL::asset('assets/img/graphics/icons/check-list.svg') }}" data-inject-svg class="img-fluid width-5x h-auto mb-5 fill-success">
                                    <!--Content-->
                        ...
                        <div class="col-md-4 col-xl-3">
                            <a href="{{ URL::asset('#!') }}"
                                ...
                                <div class="position-relative">
                                     <!--Icon-->
                                   <img src="{{ URL::asset('assets/img/graphics/icons/mail.svg') }}" data-inject-svg class="img-fluid width-5x h-auto mb-5 fill-danger">
                                   <!--Content-->
                    ...
                    <div class="px-4 rounded-block bg-primary shadow-lg py-9 px-lg-5 py-lg-11 position-relative overflow-hidden"
                        ...
                        <div class="row position-relative align-items-center justify-content-center">
                            <div class="col-lg-7 col-xl-6">
                                ...
                                <h2 class="mb-0 display-5 text-white" data-aos="fade-up" data-aos-delay="100">Still no luck?</h2>
                            </div>
                            <div class="col-lg-4 text-lg-center">
                               <div data-aos="fade-up" data-aos-delay="150">
                                    <a href="{{ URL::asset('#!') }}" class="btn btn-white btn-hover-arrow btn-lg rounded-pill"><span>Contact support</span></a>
                                 </div>
                            </div>
                        </div>
                    </div>
