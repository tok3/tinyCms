                    ...
                    <div class="row pt-lg-7">
                        <div class="col-lg-7">
                            <ol class="breadcrumb mb-3">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Classic Masonry Grid</li>
                            </ol>
                ...
                <div class="container py-9 py-lg-11 position-relative z-1">
                      ...
                      <div id="projects" data-isotope='{"layoutMode": "masonry"}' class="row">
                        ...
                        <div class="col-md-6 mb-4 figma grid-item">
                            <a href="{{ URL::asset('#!') }}" class="card-hover">
                                <div class="overflow-hidden position-relative mb-4">
                                 ...
                                 <span class="text-body-secondary">App / UI UX</span>
                             </a>
                        </div>
                        <div class="col-md-6 mb-4 bootstrap grid-item">
                            <a href="{{ URL::asset('#!') }}" class="card-hover">
                        ...
                        <div class="col-md-6 mb-4 figma grid-item">
                            <a href="{{ URL::asset('#!') }}" class="card-hover">
                                <div class="overflow-hidden position-relative mb-4">
                                 ...
                                 <h5 class="mb-1">Odio dignissimos</h5>
                                 <span class="text-body-secondary">Print / Motion</span>
                             </a>
                        </div>
                        ...
                        <div class="col-md-6 javascript grid-item">
                            <a href="{{ URL::asset('#!') }}" class="card-hover">
                                <div class="overflow-hidden position-relative mb-4">
                                 <img src="{{ URL::asset('assets/img/projects/half5.jpg') }}" alt="" class="img-zoom img-fluid">
                                </div>
                                 <h5 class="mb-1">Nemo enim ipsam</h5>
                                 <span class="text-body-secondary">Product design / Packaging</span>
                             </a>
                        </div>
                      </div>
            </div>
            ...
            <section class="bg-primary text-white position-relative px-3 py-6 py-lg-11 overflow-hidden">
                <div class="d-md-flex justify-content-center align-items-center">
                    <div class="mb-4 mb-md-0 me-md-5 me-lg-6 me-xl-7">
                        ...
                        <p class="text-white-50 mb-0">Your business deserve a stunning website. </p>
