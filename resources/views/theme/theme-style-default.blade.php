<x-assan-layout layout-type="{{$layoutType}}">
      ...
      <section class="bg-gradient-primary text-white">
        <div class="container pt-15 pb-9 pb-lg-12">
          <h2 class="display-3 mb-0 pt-lg-9 pb-lg-4">Default theme style</h2>
        </div>
      </section>
      ...
      <section class="bg-primary-subtle">
        <div class="container py-9 py-lg-11">
          ...
          <p class="mb-5 fs-4">for Theme default </p>
...
<code>
   ...
   &lt;head>
    ...
    &lt;link href="{{ URL::asset('https://fonts.googleapis.com/css2?family=Poppins:wght@200;300;400;500;600;700&family=Source+Serif+4:ital,wght@0,400;0,500;1,400;1,500&display=swap') }}" rel="stylesheet">
  ...
  &lt;/html>
      ...
      <section class="position-relative">
        ...
        <div class="container position-relative">
          <div
            class="px-4 px-lg-6 py-9 py-lg-11 shadow-lg rounded-4 bg-secondary overflow-hidden text-white position-relative">

            <!--blob shape-->
            <svg class="position-absolute end-0 bottom-0 w-50 h-auto mb-n7 text-warning" width="616" height="464"
            ...
            <!--blob shape-->
            <svg class="position-absolute end-0 bottom-0 w-50 mb-n9 me-n9 h-auto text-primary" width="616" height="464"
              viewBox="0 0 616 464" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd"
                d="M529.02 0.372621C648.093 -8.86796 677.569 156.046 749.056 240.707C795.671 295.913 839.498 347.565 874.249 409.222C915.961 483.231 978.111 552.938 971.515 635.414C964.041 728.876 936.16 850.497 836.419 882.264C730.359 916.045 640.668 790.168 529.02 776.349C443.047 765.708 360.497 838.142 278.401 813.198C186.892 785.395 118.893 715.022 75.5428 638.567C27.1616 553.239 -34.224 443.94 23.1986 363.109C82.8766 279.102 248.222 335.31 335.376 272.811C431.969 203.541 405.102 9.98913 529.02 0.372621Z"
                fill="currentColor" />
