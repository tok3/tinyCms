<x-assan-layout layout-type="{{$layoutType}}">
      ...
      <section class="bg-gradient-primary text-white">
        <div class="container pt-12 pt-lg-15 pb-9 pb-lg-12">
          <h2 class="display-3 mb-4 pt-lg-5">Theme Pink</h2>
          <p class="lead mb-0">Pink color Ui with modern font style</p>
        </div>
      </section>
        ...
        <div class="container py-9 py-lg-11">
          <div class="row mb-5 mb-lg-9 justify-content-between align-items-end">
            <div class="col-lg-9 mx-auto text-center">
              <h5 data-aos="fade-up" class="text-gradient">This is theme pink</h5>
      ...
      <section class="bg-primary-subtle">
        <div class="container py-9 py-lg-11">
          ...
          <p class="mb-5 fs-4">for Theme Pink</p>
...
<code>
   ...
   &lt;head>
    ...
    &lt;link href="{{ URL::asset('https://fonts.googleapis.com/css2?family=Lora:ital@0;1&family=Maven+Pro:wght@400..900&display=swap') }}" rel="stylesheet">
    &lt;!-- Bootstrap + vendor + theme CSS ///////////////////////////////-->
    &lt;link href="{{ URL::asset('assets/css/theme-pink.min.css') }}" rel="stylesheet">
    &lt;!--///////////////////////////////// [] ///////////////////////////////-->
      ...
      <section class="position-relative">
        ...
        <div class="container position-relative">
          <div
            ...
            <!--blob shape-->
            <svg class="position-absolute end-0 bottom-0 w-50 mb-n9 h-auto text-white" width="616" height="464"
            ...
            <!--blob shape-->
            <svg class="position-absolute end-0 bottom-0 w-50 mb-n9 me-n9 h-auto text-info" width="616" height="464"
              viewBox="0 0 616 464" fill="none" xmlns="http://www.w3.org/2000/svg">
