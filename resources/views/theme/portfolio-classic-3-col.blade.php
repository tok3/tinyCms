<x-assan-layout layout-type="{{$layoutType}}">
                    ...
                    <div class="row pt-lg-7">
                        <div class="col-lg-7">
                            <ol class="breadcrumb mb-3">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Classic 3 columns</li>
                            </ol>
            ...
            <section class="bg-primary text-white position-relative px-3 py-6 py-lg-11 overflow-hidden">
                <div class="d-md-flex justify-content-center align-items-center">
                    ...
                    </div><a class="btn btn-outline-white rounded-pill btn-hover-arrow" href="{{ URL::asset('#') }}"><span>Purchase
                            Now</span></a>
                </div>
                <!-- / .End container -->
            </section>
