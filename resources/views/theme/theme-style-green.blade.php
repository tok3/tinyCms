<x-assan-layout layout-type="{{$layoutType}}">
      ...
      <section class="bg-gradient-primary text-white">
        <div class="container pt-12 pt-lg-15 pb-9 pb-lg-12">
          <h2 class="display-3 mb-4 pt-lg-5">Theme Green</h2>
          <p class="lead mb-0">Green color Ui with modern font style</p>
        </div>
      </section>
        ...
        <div class="container py-9 py-lg-11">
          <div class="row mb-5 mb-lg-9 justify-content-between align-items-end">
            <div class="col-lg-9 mx-auto text-center">
              <h5 data-aos="fade-up" class="text-gradient">This is theme Green</h5>
      ...
      <section class="bg-primary-subtle">
        <div class="container py-9 py-lg-11">
          ...
          <p class="mb-5 fs-4">for Theme Green</p>
      ...
      <section class="position-relative">
        ...
        <div class="container position-relative">
          <div
            ...
            <!--blob shape-->
            <svg class="position-absolute end-0 bottom-0 w-50 mb-n9 h-auto text-info" width="616" height="464"
