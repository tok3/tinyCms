<x-assan-layout layout-type="{{$layoutType}}">
      ...
      <section class="bg-gradient-primary text-white">
        <div class="container pt-12 pt-lg-15 pb-9 pb-lg-12">
          <h2 class="display-4 mb-4 pt-lg-5">Theme Teal</h2>
          <p class="lead mb-0">Teal color Ui with modern font style</p>
        </div>
      </section>
        ...
        <div class="container py-9 py-lg-11">
          <div class="row mb-5 mb-lg-9 justify-content-between align-items-end">
            <div class="col-lg-9 mx-auto text-center">
              <h6 data-aos="fade-up" class="text-gradient">This is theme teal</h6>
              <h2 class="display-5 mb-0" data-aos="fade-up">Example feature icon cards
              </h2>
            </div>
          </div>
      ...
      <section class="bg-primary-subtle">
        <div class="container py-9 py-lg-11">
          <h2 class="mb-1 text-primary display-5">
            Starter template
          </h2>
          <p class="mb-5 fs-4">for Theme Teal</p>
  ...
  &lt;/html>
      ...
      <section class="position-relative">
        ...
        <div class="container position-relative">
          <div
            class="px-4 px-lg-6 py-9 py-lg-11 shadow-lg rounded-4 bg-gradient bg-secondary overflow-hidden text-white position-relative">

            <!--blob shape-->
            <svg class="position-absolute end-0 bottom-0 w-25 mb-n5 h-auto text-primary" width="616" height="464"
              viewBox="0 0 616 464" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-opacity="1" fill-rule="evenodd" clip-rule="evenodd"
            ...
            <!--blob shape-->
            <svg class="position-absolute end-0 bottom-0 w-25 mb-n5 me-n5 h-auto text-warning" width="616" height="464"
              viewBox="0 0 616 464" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-opacity="1" fill-rule="evenodd" clip-rule="evenodd"
                d="M529.02 0.372621C648.093 -8.86796 677.569 156.046 749.056 240.707C795.671 295.913 839.498 347.565 874.249 409.222C915.961 483.231 978.111 552.938 971.515 635.414C964.041 728.876 936.16 850.497 836.419 882.264C730.359 916.045 640.668 790.168 529.02 776.349C443.047 765.708 360.497 838.142 278.401 813.198C186.892 785.395 118.893 715.022 75.5428 638.567C27.1616 553.239 -34.224 443.94 23.1986 363.109C82.8766 279.102 248.222 335.31 335.376 272.811C431.969 203.541 405.102 9.98913 529.02 0.372621Z"
                fill="currentColor" />
            ...
            <div class="row position-relative">
              <div class="col-12 col-md-10 col-lg-9 offset-lg-1">
                <h3 class="mb-4 display-5" data-aos="fade-down">
