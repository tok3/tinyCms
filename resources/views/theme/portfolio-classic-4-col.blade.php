<x-assan-layout layout-type="{{$layoutType}}">
                    ...
                    <div class="row pt-lg-7">
                        <div class="col-lg-7">
                            <ol class="breadcrumb mb-3">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Classic 4 columns</li>
                            </ol>
            ...
            <section class="position-relative">
                <div class="container-fluid py-9 py-lg-11 position-relative z-1">
                             ...
                             <ul class="mb-5 nav nav-filter align-items-center justify-content-end mb-0">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="{{ URL::asset('#') }}" data-bs-toggle="pill" data-filter="*" data-bs-target="#projects">
                                        Projects
                                       </a>
                                </li>
                               <li class="nav-item">
                                <a class="nav-link small" href="{{ URL::asset('#') }}" data-bs-toggle="pill" data-filter=".bootstrap" data-bs-target="#bootstrap">
                                    Bootstrap
                                  </a>
                               </li>
                              <li class="nav-item">
                                <a class="nav-link" href="{{ URL::asset('#') }}" data-bs-toggle="pill" data-filter=".javascript" data-bs-target="#javascript">
                                    JS
                                   </a>
                              </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ URL::asset('#') }}" data-bs-toggle="pill" data-filter=".figma" data-bs-target="#figma">
                                        Figma
                                      </a>
                                </li>
                            </ul>
                      ...
                      <div id="projects" data-isotope='{"layoutMode": "masonry"}' class="row g-3">
                        ...
                        <div class="col-md-6 col-lg-3 mb-3 bootstrap grid-item">
                        ...
                        <div class="col-md-6 col-lg-3 mb-3 figma grid-item">
                            <a href="{{ URL::asset('#!') }}" class="card-hover">
                                <div class="overflow-hidden position-relative mb-4">
                        ...
                        <div class="col-md-6 col-lg-3 mb-3 mb-lg-0 bootstrap grid-item">
                            <a href="{{ URL::asset('#!') }}" class="card-hover">
                                <div class="overflow-hidden position-relative mb-4">
                        ...
                        <div class="col-md-6 col-lg-3 mb-3 mb-lg-0 javascript grid-item">
                            <a href="{{ URL::asset('#!') }}" class="card-hover">
                                <div class="overflow-hidden position-relative mb-4">
                        ...
                        <div class="col-md-6 col-lg-3 mb-3 mb-md-0 javascript grid-item">
                            <a href="{{ URL::asset('#!') }}" class="card-hover">
                                <div class="overflow-hidden position-relative mb-4">
                                 <img src="{{ URL::asset('assets/img/projects/7.jpg') }}" alt="" class="img-zoom img-fluid">
                                </div>
                                 <h5 class="mb-1">Product Design</h5>
                                 <span class="text-body-secondary">Motion - Print</span>
                             </a>
                        </div>
                        <div class="col-md-6 col-lg-3 javascript grid-item">
                            <a href="{{ URL::asset('#!') }}" class="card-hover">
                                <div class="overflow-hidden position-relative mb-4">
                                 <img src="{{ URL::asset('assets/img/projects/8.jpg') }}" alt="" class="img-zoom img-fluid">
                                </div>
                                 <h5 class="mb-1">3D Ninja</h5>
                                 <span class="text-body-secondary">UI / UX</span>
                             </a>
                        </div>
                      </div>
