<x-assan-layout layout-type="{{$layoutType}}">
            <section class="position-relative bg-primary bg-gradient text-white">
                <div class="container position-relative py-9 py-lg-15">
                    <div class="row pt-9 pt-lg-9">
                        <div class="col-xl-9">
                            <h1 class="display-4 mb-3">Header No Navbar</h1>
            ...
            <section class="border-bottom">
                ...
                <code>
                    &lt;!--Header Start-->
                    &lt;header class="z-fixed header-transparent header-absolute-top pt-lg-2">
                            ...
                            &lt;div class="container position-relative">
                                ...
                                &lt;div class="d-flex align-items-center navbar-no-collapse-items order-lg-last">
                                    ...
                                    &lt;div class="nav-item me-3 me-lg-0">
                                        &lt;a href="{{ URL::asset('#') }}" class="btn btn-outline-white border-2 btn-sm">Get Started&lt;/a>
                                    &lt;/div>
                                &lt;/div>
                            &lt;/div>
                        &lt;/nav>
                    &lt;/header>
                        ...
                        <div class="tab-pane fade" id="tabCss">
                            <div class="position-relative">
                                <button
                                    class="btn btn-sm position-absolute end-0 top-0 me-3 mt-3 z-1 btn-primary copy-link"
                                    data-clipboard-target="#copyJsCss1" data-clipboard-action="copy" id="copyCss1-2">Copy code</button>
