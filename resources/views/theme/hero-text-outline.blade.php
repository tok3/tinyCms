<x-assan-layout layout-type="{{$layoutType}}">
           ...
           <section class="position-relative bg-dark text-white jarallax" data-speed=".2">
               ...
               <div class="container pt-12 pt-lg-15 pb-12">
                   <div class="row pt-lg-4 justify-content-center text-center align-items-center">
                       <div class="col-lg-8 col-xl-7 mx-auto text-center">
                           <!--:Heading:-->
                           <h1 class="mb-4 display-1">Built for <span class="text-outline-white d-block">Every
                                   Business</span> </h1>
                           <!--:Subheading:-->
