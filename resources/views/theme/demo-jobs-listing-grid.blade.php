<x-assan-layout layout-type="{{$layoutType}}">
            <section class="bg-gradient-blur d-flex w-100 position-relative">
                ...
                <div class="container py-9 py-lg-12 position-relative">
                                ...
                                <div class="col-md-auto">
                                   <div class="d-flex">
                                    ...
                                    <div class="btn-group btn-group-sm flex-shrink-0">
                                        <a href="{{ URL::asset('demo-jobs-listing.html') }}" class="btn btn-outline-info">
                                            <i class="bx bx-list-ul fs-5"></i>
                                        </a>
                                        <a href="{{ URL::asset('demo-jobs-listing-grid.html') }}" class="btn btn-outline-info active">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4" data-aos="fade-up">
                            <!--Job card-->
                            <div class="card hover-lift hover-shadow-xl h-100 shadow-sm">
                                <!--Card-body-->
                                <div class="card-body p-4">
                                    <div>
                                        ...
                                        <div class="flex-grow-1">
                                            <div>
                                                <div class="flex-grow-1">
                                                    <h5 class="mb-3">Frontend Engineer</h5>
                                ...
                                <div class="card-body p-4">
                                    <div>
                                        ...
                                        <div class="flex-grow-1">
                                            <div>
                                                <div class="flex-grow-1">
                                                    <h5 class="mb-3">Senior Content Designer</h5>
                                                    <ul class="d-flex small flex-wrap list-unstyled mb-4">
                                                        <li class="me-3 mb-2 d-flex align-items-center"><i
                                                                class="bx bx-dollar me-1"></i>40K-80K</li>
                                                        <li class="me-3 mb-2 d-flex align-items-center"><i
                                ...
                                <div class="card-body p-4">
                                    <div>
                                        ...
                                        <div class="flex-grow-1">
                                            <div>
                                                <div class="flex-grow-1">
                                                    <h5 class="mb-3">Social Media Manager</h5>
                                                    <ul class="d-flex small flex-wrap list-unstyled mb-4">
                                                        <li class="me-3 mb-2 d-flex align-items-center"><i
                                ...
                                <div class="card-body p-4">
                                    <div>
                                        ...
                                        <div class="flex-grow-1">
                                            <div>
                                                <div class="flex-grow-1">
                                                    <h5 class="mb-3">Marketing Designer Associate </h5>
                                                    <ul class="d-flex small flex-wrap list-unstyled mb-4">
                                                        <li class="me-3 mb-2 d-flex align-items-center"><i
                                ...
                                <div class="card-body p-4">
                                    <div>
                                        ...
                                        <div class="flex-grow-1">
                                            <div>
                                                <div class="flex-grow-1">
                                                    <h5 class="mb-3">Senior User Researcher</h5>
                                                    <ul class="d-flex small flex-wrap list-unstyled mb-4">
                                                        <li class="me-3 mb-2 d-flex align-items-center"><i
                                                                class="bx bx-dollar me-1"></i>40K-80K</li>
                                                        <li class="me-3 mb-2 d-flex align-items-center"><i
                                ...
                                <div class="card-body p-4">
                                    <div>
                                        ...
                                        <div class="flex-grow-1">
                                            <div>
                                                <div class="flex-grow-1">
                                                    <h5 class="mb-3">Product Marketing Manager</h5>
                                                    <ul class="d-flex small flex-wrap list-unstyled mb-4">
                                                        <li class="me-3 mb-2 d-flex align-items-center"><i
                                                                class="bx bx-dollar me-1"></i>40K-80K</li>
                                                        <li class="me-3 mb-2 d-flex align-items-center"><i
...
<!--Filter-->
<div data-aos="fade-up" class="card shadow-sm card-body p-4 mb-4">
    ...
    <a href="{{ URL::asset('#!') }}">Clear All</a>
                            ...
                            <!--Apply now-->
                            <div data-aos="fade-up" class="card shadow-sm card-body p-4">
