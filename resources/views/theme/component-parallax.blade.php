<x-assan-layout layout-type="{{$layoutType}}">
           ...
           <section class="bg-gradient-primary text-white position-relative">
                                    ...
                                    <nav class="d-flex justify-content-center" aria-label="breadcrumb">
                                        <div class="mb-4">
                                            <ol class="breadcrumb mb-0">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page">Parallax</li>
                                            </ol>
                                        </div>
                                    </nav>
            ...
            <section class="position-relative jarallax bg-dark" data-speed="0.2">
                <img src="{{ URL::asset('assets/img/backgrounds/bg6.jpg') }}" alt="" class="jarallax-img">
                <div class="container py-9">
                    <div class="row vh-75 align-items-center">
                        <div class="col-12">
                            <h3 class="text-white display-3">Parallax image background</h3>
                        </div>
                    </div>
                </div>
                </div>
            </section>
            <section class="position-relative jarallax bg-dark" data-video-src="{{ URL::asset('https://vimeo.com/40842620') }}" data-speed=".2">
                <div class="container py-9">
                    <div class="row vh-75 align-items-center">
                        <div class="col-12">
                            <h3 class="text-white display-3">Parallax Video background</h3>
                        </div>
                    </div>
                </div>
                </div>
