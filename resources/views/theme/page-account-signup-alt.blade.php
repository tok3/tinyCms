<x-assan-layout layout-type="{{$layoutType}}">
            ...
            <section class="position-relative d-flex justify-content-center align-items-center h-100">
                <div class="bg-dark d-none d-md-flex position-fixed end-0 top-0 w-md-50 w-lg-60 h-100">
                    ...
                    <!--Image-->
                    <img src="{{ URL::asset('assets/img/backgrounds/bg3.jpg') }}" alt="" class="bg-image">
                </div>
                        ...
                        <div class="col-lg-4 pt-3 pb-4 pb-lg-5 pt-lg-5 me-auto col-md-6 z-2">
                            <div>
                               ...
                               <a class="navbar-brand" href="{{ URL::asset('index.html') }}">
                                <img src="{{ URL::asset('assets/img/logo/logo.svg') }}" alt="" class="width-10x navbar-brand-light mb-5">
                                <img src="{{ URL::asset('assets/img/logo/logo-white.svg') }}" alt="" class="width-10x navbar-brand-dark mb-5">
                            </a>
                                <div>
                                        ...
                                        <div class="mb-3 d-flex justify-content-between">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label small text-body-secondary" for="flexCheckDefault">
                                                    Agree to <a href="{{ URL::asset('#!') }}" class="fw-semibold">Terms & conditions</a>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <p class="pt-3 small text-body-tertiary">
                                        Already have an account? <a href="{{ URL::asset('page-account-signin-alt.html') }}"
                                    ...
                                    <div class="d-grid">
                                        <a href="{{ URL::asset('#!') }}"
                                            ...
                                            <div class="position-relative d-flex align-items-center">
                                                <img src="{{ URL::asset('assets/img/brands/twitter.svg') }}" alt="" class="width-2x me-2">
