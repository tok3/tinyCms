<x-assan-layout layout-type="{{$layoutType}}">
            <section class="position-relative bg-dark text-white">
                <div class="container position-relative py-9 py-lg-15">
                    <div class="row pt-9">
                        <div class="col-xl-9">
                            <h1 class="display-4 mb-3">Header Center Logo</h1>
            ...
            <section class="border-bottom">
                ...
                <code>
&lt;!--Header Start-->
&lt;header class="z-fixed header-transparent header-absolute-top sticky-reverse header-center-logo">
  ...
  &lt;div class="container position-relative">
     ...
     &lt;div class="d-flex align-items-center navbar-no-collapse-items order-lg-last">
       ...
       &lt;div class="nav-item me-3 me-lg-0">
        &lt;a href="{{ URL::asset('#') }}" class="btn btn-sm btn-primary rounded-pill" data-bs-toggle="dropdown">
           Purchase
        &lt;/a>
    &lt;/div>
   &lt;/div>
   &lt;div class="collapse navbar-collapse" id="mainNavbarTheme">
      ...
      &lt;ul class="navbar-nav me-lg-auto">
        &lt;li class="nav-item"> &lt;a href="{{ URL::asset('#') }}" class="nav-link">Home&lt;/a> &lt;/li>
        &lt;li class="nav-item"> &lt;a href="{{ URL::asset('#') }}" class="nav-link">About&lt;/a> &lt;/li>
        &lt;li class="nav-item"> &lt;a href="{{ URL::asset('#') }}" class="nav-link">Projects&lt;/a> &lt;/li>
      &lt;/ul>
      &lt;!--Navbar right-->
      &lt;ul class="navbar-nav ms-lg-auto">
         &lt;li class="nav-item"> &lt;a href="{{ URL::asset('#') }}" class="nav-link">Services&lt;/a>&lt;/li>
         &lt;li class="nav-item">&lt;a href="{{ URL::asset('#') }}" class="nav-link">Contact&lt;/a>&lt;/li>
      &lt;/ul>
    &lt;/div>
  &lt;/div>
 &lt;/nav>
