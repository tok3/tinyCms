<x-assan-layout layout-type="{{$layoutType}}">
            <section class="position-relative bg-gradient-primary text-white">
             ...
             <div class="row pt-9 pt-lg-12">
                 <div class="col-lg-8">
                     <h1>Layout - Sidebar end</h1>
                     <nav aria-label="breadcrumb">
                         <ol class="breadcrumb mb-0">
                             <li class="breadcrumb-item"><a href="{{ URL::asset('#') }}">Home</a></li>
                             <li class="breadcrumb-item"><a href="{{ URL::asset('#') }}">Features</a></li>
                             <li class="breadcrumb-item active" aria-current="page">Layout - Sidebar end</li>
                         </ol>
                     </nav>
                 </div>
             </div>    
            ...
            <section class="position-relative border-bottom">
             <div class="container py-9 py-lg-11">
                 <div class="row">
                     ...
                     <!--Sidebar-->
                     <div class="col-lg-3 order-lg-last mb-9 mb-lg-0">
                           <!--widget-->
                     ...
                     <div class="col-lg-9">
                         <div class="row mb-5">
                             <div class="col-md-4 mb-5 mb-md-0">
                                <img src="{{ URL::asset('assets/img/960x1140/2.jpg') }}" class="img-fluid rounded-3" alt="">
                             </div>
