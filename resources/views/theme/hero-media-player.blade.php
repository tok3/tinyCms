<x-assan-layout layout-type="{{$layoutType}}">
            ...
            <section class="position-relative bg-gradient-blur">
                <div class="container position-relative pt-12 pb-0">
                    <div class="row pt-lg-5">
                        <div class="col-lg-10 text-center mx-lg-auto">
                            ...
                            <div class="mb-7">
                                <a href="{{ URL::asset('#!') }}" class="btn btn-lg px-4 px-lg-5 rounded-pill btn-primary">Get started
                                    today</a>
                            </div>
                            <!--:Video Player:-->
                ...
                <svg class="position-absolute start-0 bottom-0" style="color: var(--bs-body-bg);"
                    preserveAspectRatio="none" width="100%" height="96" viewBox="0 0 1460 120" fill="none"
                ...
                <div class="container pt-9 pt-lg-11">
                    ...
                    <div class="position-relative" style="max-height:75vh; overflow-y:auto">
                        <button
                            ...
                            data-clipboard-target="#copyHTML1" data-clipboard-action="copy" id="copyHTML1-1">Copy
                            code</button>
