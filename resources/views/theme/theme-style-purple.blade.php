<x-assan-layout layout-type="{{$layoutType}}">
      ...
      <section class="bg-gradient-primary text-white">
        <div class="container pt-12 pt-lg-15 pb-9 pb-lg-12">
          <h2 class="display-3 mb-4 pt-lg-5">Theme Purple</h2>
          <p class="lead mb-0">Different Ui colors and font style</p>
        </div>
      </section>
      ...
      <section class="bg-primary-subtle">
        <div class="container py-9 py-lg-11">
          ...
          <p class="mb-5 fs-4">for Theme purple</p>
      ...
      <section class="position-relative">
        ...
        <div class="container position-relative">
          <div
            ...
            <!--blob shape-->
            <svg class="position-absolute end-0 bottom-0 w-25 h-auto text-warning" width="616" height="464"
