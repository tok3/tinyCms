<x-assan-layout layout-type="{{$layoutType}}">
            <section class="position-relative text-center bg-primary-subtle">
                <div class="container position-relative pt-9 pb-9">
                    <div class="row pt-5 pt-lg-11">
                        <div class="col-xl-9 mx-auto">
                            <h1 class="display-4 mb-3">Header shopping cart</h1>
                ...
                &lt;div class="d-flex align-items-center navbar-no-collapse-items order-lg-last">
                    ...
                    &lt;div class="nav-item me-3 ms-lg-5 me-lg-0 dropdown position-static">
                        &lt;a href="{{ URL::asset('#') }}" data-bs-toggle="dropdown" class="nav-link flex-center position-relative">
                            ...
                            &lt;span
                                class="cart-number width-2x height-2x small bg-white rounded-circle text-primary shadow-sm flex-center position-absolute end-0 top-0 me-n3 mt-n1">3&lt;/span>
                        &lt;/a>
                            ...
                            &lt;ul class="list-unstyled mb-0">
                                &lt;li class="d-flex align-items-center p-3 pb-0">
                                    &lt;div class="me-0">
                                        &lt;a href="{{ URL::asset('#!') }}">&lt;img src="assets/img/shop/backpack2.jpg"
                                                class="height-10x hover-lift hover-shadow w-auto rounded-3" alt="">&lt;/a>
                                    &lt;/div>
                                    &lt;div class="flex-grow-1 px-4 mb-3">
                                        &lt;a href="{{ URL::asset('#!') }}" class="d-block lh-sm fw-semibold mb-2">Laptop backpack water proof&lt;/a>
                                        &lt;p class="mb-0 small">&lt;small
                                                class="text-body-secondary">$&lt;/small>&lt;strong>49.00&lt;/strong> x
                                            &lt;strong>1&lt;/strong>&lt;/p>
                                    &lt;/div>
                                    &lt;div class="d-block text-end">
                                        &lt;a href="{{ URL::asset('#!') }}" class="text-body-secondary">
                                            &lt;svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                fill="currentColor" class="bx bx-x" viewBox="0 0 16 16">
                                                &lt;path
                                ...
                                &lt;li class="d-flex p-3 align-items-center">
                                    ...
                                    &lt;div class="flex-grow-1 px-4 mb-3">
                                        ...
                                        &lt;p class="mb-0 small">&lt;small
                                                class="text-body-secondary">$&lt;/small>&lt;strong>64.00&lt;/strong> x
                                            &lt;strong>1&lt;/strong>&lt;/p>
                                    &lt;/div>
                                    &lt;div class="d-block text-end">
                                        &lt;a href="{{ URL::asset('#!') }}" class="text-body-secondary">
