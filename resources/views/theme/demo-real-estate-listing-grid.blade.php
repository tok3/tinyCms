                    ...
                    <form class="position-relative z-1 mt-n9 mt-lg-n7 px-3 pb-3 pb-lg-0 pt-2 mb-5 bg-body border border-primary rounded-3">
                        <div class="row mx-0 g-2 align-items-center">
                            ...
                            <div class="col-md-6 col-lg-3">
                                ...
                                <select class="form-control form-control-lg border-0 shadow-none ps-0 pe-5" data-choices='{"searchEnabled":false,"itemSelectText":""}' name="p_for" id="p_type">
                            ...
                            <div class="col-md-9 col-lg-4">
                                ...
                                <div class="position-relative">
                                    <i
                                        class="bx bx-map small ms-0 opacity-50 position-absolute start-0 top-50 translate-middle-y"></i>
                ...
                <div class="container py-9 py-lg-11">
                    <div class="row mb-4">
                        ...
                        <div class="col-6 text-end">
                           <div class="btn-group ms-auto btn-group-sm">
                               <a class="btn btn-outline-secondary rounded-end-0 rounded-pill" href="{{ URL::asset('demo-real-estate-listing-row.html') }}">
                               ...
                               <a class="btn btn-outline-secondary rounded-start-0 rounded-pill active" href="{{ URL::asset('demo-real-estate-listing-grid.html') }}">
                    ...
                    <div class="col-md-6 col-lg-4">
                     ...
                     <div class="card rounded-3 mb-5" data-aos="fade-up">
                        ...
                        <div class="card-body overflow-hidden p-4 px-lg-5 flex-grow-1">
                            <span class="badge text-bg-warning mb-3">For rent</span>
                            <a href="{{ URL::asset('#!') }}" class="text-dark d-block mb-4">
                                <h4>Villa in Coral Gables</h4>
                            </a>
                            <div class="row mb-3 mb-lg-4">
                    ...
                    <div class="d-flex justify-content-center" data-aos="fade-up">
                        <a href="{{ URL::asset('#!') }}" class="btn btn-secondary rounded-pill btn-lg hover-lift">
                            Load more
                        </a>
                    </div>
                </div>
