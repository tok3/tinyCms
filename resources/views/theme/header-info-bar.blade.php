<x-assan-layout layout-type="{{$layoutType}}">
            <section class="position-relative bg-primary-subtle">
                <div class="container position-relative py-9 py-lg-15">
                    <div class="row">
                        <div class="col-xl-9">
                            <h1 class="display-4 mb-3">Header Info bar</h1>
                ...
                &lt;div class="col-5">
                    &lt;ul class="list-inline mb-0">
                        &lt;li class="list-inline-item me-0">
                            &lt;a href="{{ URL::asset('#!') }}"
                                class="d-inline-block text-reset si rounded-pill width-2x height-2x si-hover-facebook">
                        ...
                        &lt;li class="list-inline-item me-0">
                            &lt;a href="{{ URL::asset('#!') }}"
                                class="d-inline-block text-reset si rounded-pill width-2x height-2x si-hover-twitter">
                        ...
                        &lt;li class="list-inline-item">
                            &lt;a href="{{ URL::asset('#!') }}"
                                class="d-inline-block text-reset si rounded-pill width-2x height-2x si-hover-linkedin">
                    ...
                    &lt;div class="d-flex align-items-center justify-content-end">
                        &lt;span class="me-3 text-body-secondary small">
                            &lt;i class="bx bx-phone d-none d-sm-inline-block me-2 align-middle">&lt;/i>&lt;a
                                href="{{ URL::asset('tel:0123456789') }}">+01 555 1234 789&lt;/a>
                        &lt;/span>
                        &lt;a href="{{ URL::asset('#') }}" class="small">&lt;i
                                class="bx bx-user-circle d-none d-sm-inline-block me-2 align-middle">&lt;/i>Login&lt;/a>
                    &lt;/div>
                &lt;/div>
            &lt;/div>
        &lt;/div>
