<x-assan-layout layout-type="{{$layoutType}}">
                                ...
                                <div class="row h-100 align-items-center">
                                    <div class="col-xl-8 col-lg-10 mx-auto text-center">
                                        <ul class="carousel-layers list-unstyled mb-0">
                                            ...
                                            <li data-carousel-layer="fade-start">
                                                <a href="{{ URL::asset('#') }}" class="btn btn-white btn-lg">
                                                    How it works
                                                </a>
                                            </li>
                                        </ul>
                        ...
                        <div class="col-md-8 col-lg-9">
                            ...
                            <div class="d-flex flex-wrap justify-content-md-end justify-content-center">
                                ...
                                <div
                                    ...
                                    <img class="img-fluid img-invert" src="{{ URL::asset('assets/img/partners/dark/nasdaq.svg') }}" alt="">
                                </div>
                                <!--Partner-->
                                <div
                                    class="d-flex justify-content-center align-items-center px-4 py-3 width-13x h-auto">
                                    <img class="img-fluid img-invert" src="{{ URL::asset('assets/img/partners/dark/zillow.svg') }}" alt="">
                                </div>
                                <!--Partner-->
                                <div
                                    class="d-flex justify-content-center align-items-center px-4 py-3 width-13x h-auto">
                                    <img class="img-fluid img-invert" src="{{ URL::asset('assets/img/partners/dark/slack.svg') }}" alt="">
                                </div>
                                <!--Partner-->
                                <div
                                    class="d-flex justify-content-center align-items-center px-4 py-3 width-13x h-auto">
                                    <img class="img-fluid img-invert" src="{{ URL::asset('assets/img/partners/dark/google.svg') }}" alt="">
                                </div>
                                <!--Partner-->
                                <div
                                    class="d-flex justify-content-center align-items-center px-4 py-3 width-13x h-auto">
                                    <img class="img-fluid img-invert" src="{{ URL::asset('assets/img/partners/dark/amazon.svg') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-5 mb-md-0" data-aos="fade-right" data-aos-delay="100"
                           ...
                           <div class="width-5x height-5x mb-5 flex-center">
                            <img data-inject-svg src="{{ URL::asset('assets/img/graphics/icons/hand-shake.svg') }}"
                        ...
                        <div class="col-md-4 mb-5 mb-md-0" data-aos="fade-right" data-aos-delay="150"
                           ...
                           <!--:Icon:-->
                           <div class="width-5x height-5x mb-5 flex-center">
                            <img data-inject-svg src="{{ URL::asset('assets/img/graphics/icons/target.svg') }}"
                        ...
                        <div class="col-md-4" data-aos="fade-right" data-aos-delay="200" data-aos-duration="400">
                            <!--:Icon:-->
                           <div class="width-5x height-5x mb-5 flex-center">
                            <img data-inject-svg src="{{ URL::asset('assets/img/graphics/icons/magic-wand.svg') }}"
                ...
                <div class="container py-9 py-lg-11 position-relative">
                    <div class="row justify-content-between">
                        <div class="col-lg-5 mb-7 mb-lg-0">
                            ...
                            <div class="w-lg-75">
                                <nav class="nav nav-vertical position-relative z-1 flex-column" role="tablist" style="--bs-nav-pills-link-active-bg:var(--bs-secondary-bg);--bs-nav-pills-link-active-color:var(--bs-primary)">
                                    ...
                                    <a href="{{ URL::asset('#code') }}" class="nav-link rounded-pill active px-5 fs-5 py-3 mb-1"
                                        data-bs-toggle="tab"><span>Code</span></a>
                                    <a href="{{ URL::asset('#strategy') }}" class="nav-link rounded-pill fs-5 px-5 py-3 mb-1"
                                        data-bs-toggle="tab"><span>Strategy</span></a>
                                    <a href="{{ URL::asset('#design') }}" class="nav-link rounded-pill fs-5 px-5 py-3"
            ...
            <section class="jarallax text-white position-relative overflow-hidden bg-dark" data-speed=".2">
                ...
                <img src="{{ URL::asset('assets/img/backgrounds/bg3.jpg') }}" class="jarallax-img" alt="">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="d-flex align-items-center justify-content-start">
                                                ...
                                                <div class="position-relative me-3">
                                                    <!--Avatar Image-->
                                                    <img class="position-relative avatar lg rounded-circle p-1"
                                                        src="{{ URL::asset('assets/img/avatar/7.jpg') }}" alt="">
                                                </div>
                                                <div>
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="d-flex align-items-center justify-content-start">
                                                ...
                                                <div class="position-relative me-3">
                                                    <!--Avatar Image-->
                                                    <img class="position-relative avatar lg rounded-circle p-1"
                                                        src="{{ URL::asset('assets/img/avatar/8.jpg') }}" alt="">
                                                </div>
                                                <div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="position-relative">
                                            ...
                                            <div class="d-flex align-items-center justify-content-start">
                                                ...
                                                <div class="position-relative me-3">
                                                    <img class="position-relative avatar lg rounded-circle p-1"
                                                        src="{{ URL::asset('assets/img/avatar/9.jpg') }}" alt="">
                                                </div>
                                                <div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-5 mb-7 mb-lg-0">
                            ...
                            <div class="d-flex flex-column flex-md-row align-items-md-center" data-aos="fade-up">
                                <span class="me-md-4 mb-3 mb-md-0">
                                    <a href="{{ URL::asset('#!') }}" class="btn btn-primary">Contact us</a>
                                </span>
                        ...
                        <div class="col-lg-6 ms-auto">
                            <div class="position-relative pe-7 pb-7" data-aos="fade-up">
                                ...
                                <!--Image-->
                                <div class="bg-mask">
                                    <img src="{{ URL::asset('assets/img/960x900/2.jpg') }}" alt="" class="mask-image mask-blob-3">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container py-9 py-lg-11 position-relative z-1">
                    <div class="row mb-7">
                        <div class="col-lg-8 mx-auto text-center">
                            ...
                            <div class="mb-3" data-aos="fade-up">
                                <h1 class="mb-0 display-5">Our work process
                                </h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="position-relative">
                        <div class="row position-relative z-1">
                            ...
                            <div class="col-lg-4 mb-4 mb-lg-0" data-aos="fade-up" data-aos-duration="400"
                                ...
                                <article class="card-hover hover-lift">
                                    <div class="position-relative rounded-3 overflow-hidden">
                                        <img src="{{ URL::asset('assets/img/960x640/4.jpg') }}" class="img-fluid img-zoom" alt="">
                                    </div>
                                    <div class="pt-4">
                                        <h4 class="link-multiline">
                            ...
                            <div class="col-lg-4" data-aos="fade-up" data-aos-duration="400" data-aos-delay="150">
                                ...
                                <article class="card-hover hover-lift">
                                    <div class="position-relative rounded-3 overflow-hidden">
                                        <img src="{{ URL::asset('assets/img/960x640/5.jpg') }}" class="img-fluid img-zoom" alt="">
                                    </div>
                                    <div class="pt-4">
                                        <h4 class="link-multiline">
