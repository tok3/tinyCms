            ...
            <section class="position-relative overflow-hidden">
                ...
                <div class="ms-skin-black-1 master-slider" id="masterslider">
                    ...
                    <div class="ms-slide bg-dark" data-delay="3" data-fill-mode="fill">
                        <img class="opacity-50" src="{{ URL::asset('assets/vendor/masterslider/style/blank.gif') }}" alt="" title=""
                            data-src="{{ URL::asset('assets/img/backgrounds/bg4.jpg') }}" />
                        <!--Layer text-->
                        ...
                        <!--Layer button-->
                        <a href="{{ URL::asset('#') }}" class="ms-layer ms-btn" data-effect="front(800)" data-duration="1200"
                    ...
                    <div class="ms-slide bg-dark" data-delay="3" data-fill-mode="fill">
                        <!--bg-->
                        <img class="opacity-50" src="{{ URL::asset('assets/vendor/masterslider/style/blank.gif') }}" alt="" title=""
                            data-src="{{ URL::asset('assets/img/backgrounds/bg3.jpg') }}" />
                        ...
                        <!--Layer button-->
                        <a href="{{ URL::asset('#') }}" class="ms-layer ms-btn" data-effect="skewbottom(-10,150)" data-duration="1000"
                    ...
                    <div class="ms-slide bg-dark" data-delay="3" data-fill-mode="fill">
                        ...
                        <!--Layer button-->
                        <a href="{{ URL::asset('#') }}" class="ms-layer ms-btn" data-effect="skewleft(23,500)" data-duration="1000"
