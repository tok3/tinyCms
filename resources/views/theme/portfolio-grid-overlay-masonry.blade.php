                    ...
                    <div class="row pt-lg-7">
                        <div class="col-lg-7">
                            <ol class="breadcrumb mb-3">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">grid overlay masonry grids</li>
                            </ol>
                 ...
                 <ul class="mb-5 nav nav-pills d-inline-flex align-items-center mb-0">
                    ...
                    <li class="nav-item">
                      ...
                      <div id="projects" data-isotope='{"layoutMode": "masonry"}' class="row g-3">
                        ...
                        <div class="col-md-6 development grid-item">
                            <a href="{{ URL::asset('#!') }}" class="text-white bg-dark position-relative d-block overflow-hidden card-hover-2">
                                <img src="{{ URL::asset('assets/img/projects/half2.jpg') }}" alt="" class="w-100 img-zoom">
                        ...
                        <div class="col-md-6 motion grid-item">
                            <a href="{{ URL::asset('#!') }}" class="text-white bg-dark position-relative d-block overflow-hidden card-hover-2">
                                <img src="{{ URL::asset('assets/img/projects/5.jpg') }}" alt="" class="w-100 img-zoom">
                                <div class="card-hover-2-overlay position-absolute start-0 top-0 w-100 h-100 d-flex px-4 py-5 flex-column justify-content-between">
                                    <div class="card-hover-2-header w-100">
                                        <div class="card-hover-2-title">
                                            <h5 class="fs-4 mb-2">Doloremque laudantium</h5>
                                        </div>
                                        <p class="mb-0">
                                           Lorem lipsum dolor sit amet...
                                        </p>
                        ...
                        <div class="col-md-6 motion grid-item">
                            <a href="{{ URL::asset('#!') }}" class="text-white bg-dark position-relative d-block overflow-hidden card-hover-2">
                                ...
                                <div class="card-hover-2-overlay position-absolute start-0 top-0 w-100 h-100 d-flex px-4 py-5 flex-column justify-content-between">
                                    <div class="card-hover-2-header w-100">
                                        <div class="card-hover-2-title">
                                            <h5 class="fs-4 mb-2">Saepe eveniet</h5>
                                        </div>
                                        <p class="mb-0">
                                           Lorem lipsum dolor sit amet...
                                        </p>
                        ...
                        <div class="col-md-6 design development grid-item">
                            <a href="{{ URL::asset('#!') }}" class="text-white bg-dark position-relative d-block overflow-hidden card-hover-2">
                        ...
                        <div class="col-md-6 motion grid-item">
                            <a href="{{ URL::asset('#!') }}" class="text-white bg-dark position-relative d-block overflow-hidden card-hover-2">
                                <img src="{{ URL::asset('assets/img/projects/7.jpg') }}" alt="" class="w-100 img-zoom">
                                <div class="card-hover-2-overlay position-absolute start-0 top-0 w-100 h-100 d-flex px-4 py-5 flex-column justify-content-between">
                                    <div class="card-hover-2-header w-100">
                                        <div class="card-hover-2-title">
                                            <h5 class="fs-4 mb-2">Similique sunt</h5>
                        ...
                        <div class="col-md-6 design grid-item">
                            <a href="{{ URL::asset('#!') }}" class="text-white bg-dark position-relative d-block overflow-hidden card-hover-2">
                        ...
                        <div class="col-md-6 motion grid-item">
                            <a href="{{ URL::asset('#!') }}" class="text-white bg-dark position-relative d-block overflow-hidden card-hover-2">
                                <img src="{{ URL::asset('assets/img/projects/half5.jpg') }}" alt="" class="w-100 img-zoom">
                                <div class="card-hover-2-overlay position-absolute start-0 top-0 w-100 h-100 d-flex px-4 py-5 flex-column justify-content-between">
                                    <div class="card-hover-2-header w-100">
                                        <div class="card-hover-2-title">
                                            <h5 class="fs-4 mb-2">Similique sunt</h5>
