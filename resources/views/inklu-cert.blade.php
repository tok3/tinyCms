<x-blank-layout>
    ...
    <section class="position-relative d-flex justify-content-center h-100">
                ...
                <div class="col-lg-4 pt-3 pb-4 pb-lg-5 pt-lg-5 me-auto col-md-6 z-2">
                    <div>
                        ...
                        <a class="navbar-brand" href="{{url('/')}}">
                            <img src="{{url('assets/img/logo/logo.svg')}}" alt="logo aktion barrierfrei hell" class="width-10x navbar-brand-light mb-5">
                            <img src="{{url('assets/img/logo/logo-white.svg')}}" alt="logo aktion barrierefrei dark mode" class="width-10x navbar-brand-dark mb-5">
                        </a>
                        <h1>PDF - Check</h1>
                        @if (session('success'))
        ...
        @csrf
        <fieldset>
            <legend>PDF Validit&auml;t pr&uuml;fen</legend>
            <div>
            <label>
                <input type="radio" checked=checked name="input_type" value="text" checked onclick="toggleInput('text')">
                Dokumenten - ID&nbsp;
            </label>
        </div>
        <div>
        ...
        <div id="text_input" style="display: block;" class="mt-4">
            <label for="text_input_field">ID</label>
            <input type="text" id="text_input_field" name="text_input"></input>
        </div>
        <div id="file_input" style="display: none;" class="mt-4">
            <label for="file_input_field">upload</label>
            <input type="file" id="file_input_field" name="file" class="btn btn-primary mt-2">
        </div>
