                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="d-flex align-items-center navbar-no-collapse-items order-lg-last">
                            ...
                            <div class="nav-item me-2 ms-lg-5 me-lg-0">
                                <!--:Btn blur:-->
                                <a href="{{ URL('assan/demo-real-estate-add-listing.html') }}" class="btn btn-warning btn-blur position-relative overflow-hidden">
                            ...
                            <ul class="navbar-nav ms-auto">
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="{{ URL::asset('assan/demo-real-estate.html') }}" class="dropdown-item">Home default</a>
