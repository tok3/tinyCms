            ...
            <div class="collapse navbar-collapse" id="mainNavbarTheme">
             ...
             <ul class="navbar-nav me-lg-3 ms-lg-auto">
                 ...
                 <li class="nav-item dropdown">
                  <a href="{{ URL::asset('#') }}" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">Jobs listing</a>
                  <div class="dropdown-menu">
                      <a class="dropdown-item" href="{{ URL::asset('demo-jobs-listing.html') }}">Lisitng Row</a>
                      <a class="dropdown-item active" href="{{ URL::asset('demo-jobs-listing-grid.html') }}">Lisitng Grid</a>
                  </div>
                 </li>
                 <li class="nav-item dropdown">
                ...
                <script>
                    var jobLocations = [
                        ...
                        },
                        {
                            id: 2,
                            value: 'United States',
                            label: '<img src="{{ URL::asset('assets/img/country/us.svg') }}" class="width-1x rounded-pill me-2" alt=""> United States'
                        },
                        {
                            id: 3,
                            value: 'United Kingdom',
                            label: '<img src="{{ URL::asset('assets/img/country/gb.svg') }}" class="width-1x rounded-pill me-2" alt=""> United Kingdom'
                        },
                        {
                            id: 4,
                            value: 'Spain',
                            label: '<img src="{{ URL::asset('assets/img/country/es.svg') }}" class="width-1x rounded-pill me-2" alt=""> Spain'
                        },
                        {
                            id: 5,
                            value: 'France',
                            label: '<img src="{{ URL::asset('assets/img/country/fr.svg') }}" class="width-1x rounded-pill me-2" alt=""> France'
                        },
                        {
                            id: 6,
                            value: 'Germany',
                            label: '<img src="{{ URL::asset('assets/img/country/de.svg') }}" class="width-1x rounded-pill me-2" alt=""> Germany'
                        }
                    ];
