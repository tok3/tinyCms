...
<html lang="en">
    ...
    <body>
       ...
       <!--Header Start-->
       <header class="z-fixed header-transparent header-absolute-top">
        ...
        <!--Main content-->
        <main class="main-content bg-gradient bg-secondary text-white z-2 shadow-lg position-relative" id="main-content">
{{$slot}}
        </main>
  ...
  <circle cx="50" cy="50" r="40" fill="none" stroke="currentColor" stroke-width="4" stroke-dasharray="0, 251.2"></circle>
       ...
       <div class="footer-fixed position-fixed start-0 bottom-0 w-100">
