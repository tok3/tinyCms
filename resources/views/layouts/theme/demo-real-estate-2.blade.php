...
<html lang="en">
    ...
    <body>
        ...
        <!--Header Start-->
        <header class="z-fixed pt-2 pt-lg-3 header-absolute-top header-boxed header-sticky">
            <div class="container text-white position-relative">
                <div class="row">
                    <div class="col-6">
                        <div class="d-flex">
                            <a href="{{ URL::asset('tel:+011234567890') }}" class="me-3 me-lg-4 d-none d-lg-block">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark">
                <div class="container position-relative">
                    <a class="navbar-brand width-3x" href="{{ URL::asset('demo-real-estate.html') }}">
                        <img src="{{ URL::asset('assets/img/logo/logo-a-white.svg') }}" alt="" class="img-fluid">
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="mainNavbarTheme">
                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item dropdown">
                                <a href="{{ URL::asset('#') }}" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">Home</a>
                                <!--Dropdown-->
                            ...
                            <li class="nav-item dropdown">
                                <a href="{{ URL::asset('#') }}" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Listing</a>
                                <!--Dropdown-->
                                <div class="dropdown-menu">
