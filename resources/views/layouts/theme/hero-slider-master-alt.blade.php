...
<html lang="en" data-bs-theme="light">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ URL::asset('assets/vendor/masterslider/skins/minimal/style.css') }}">
    ...
    <body>
        ...
        <!--Header Start-->
        <header class="z-fixed pt-lg-2 header-transparent header-absolute-top">
