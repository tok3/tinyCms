        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="col-lg-3 col-md-12 mb-7 mb-lg-0">
                    <a href="{{ URL::asset('demo-jobs.html') }}">
                    ...
                    <div class="col-lg-2 col-sm-5 col-md-3 mb-7 mb-md-0">
                        ...
                        <a href="{{ URL::asset('#') }}" class="d-block mb-2 mb-lg-3">Jobs</a>
                        <a href="{{ URL::asset('#') }}" class="d-block mb-2 mb-lg-3">Press</a>
                        <a href="{{ URL::asset('#') }}" class="d-block mb-2 mb-lg-3">Companies</a>
                        <a href="{{ URL::asset('#') }}" class="d-block mb-2 mb-lg-3">Pricing</a>
                        <a href="{{ URL::asset('#') }}" class="d-block mb-2 mb-lg-3">Updates</a>
                        <a href="{{ URL::asset('#') }}" class="d-block mb-2 mb-lg-3">Community</a>
                        <a href="{{ URL::asset('#') }}" class="d-block mb-2 mb-lg-3">Terms</a>
                        <a href="{{ URL::asset('#') }}" class="d-block">Privacy</a>
                    </div>
                    <div class="col-md-4 col-sm-7 col-lg-3 mb-7 mb-md-0">
                        <h6 class="mb-4">Top Categories</h6>
                        <a href="{{ URL::asset('#') }}" class="d-block mb-2 mb-lg-3">Business Management</a>
                        <a href="{{ URL::asset('#') }}" class="d-block mb-2 mb-lg-3">Developers</a>
                        <a href="{{ URL::asset('#') }}" class="d-block mb-2 mb-lg-3">Sales & Marketing</a>
                        <a href="{{ URL::asset('#') }}" class="d-block mb-2 mb-lg-3">Designer</a>
                        <a href="{{ URL::asset('#') }}" class="d-block mb-2 mb-lg-3">Finance</a>
                        <a href="{{ URL::asset('#') }}" class="d-block mb-2 mb-lg-3">Data Science</a>
                        <a href="{{ URL::asset('#') }}" class="d-block mb-2 mb-lg-3">Content Creator</a>
                        <a href="{{ URL::asset('#') }}" class="d-block">Legal Adviser</a>
                    </div>
                    <div class="col-lg-4 col-md-5">
                        ...
                        <div><a href="{{ URL::asset('mailto:hello@domain.com?subject=Hello!') }}" class="fs-5 link-hover-underline">support@domain.com</a>
                        </div>
