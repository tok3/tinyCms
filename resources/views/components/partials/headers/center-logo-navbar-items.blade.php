...
@endphp
<!--begin:navbar-items-left-->
<ul class="navbar-nav me-lg-auto">
   <!--begin:landings-->
  <li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle {{ $page === 'home' ? 'active' : '' }}" href="index.html" role="button"
        ...
        <div class="row mx-0">
          <div class="col-lg-5 position-relative">
            <div class="py-1 py-lg-3 d-lg-flex flex-column">
              ...
              <a href="index-landing-boxed.html" class="dropdown-item">Landing Boxed <span class="badge bg-success ms-2">New</span></a>
  ...
  <!--begin:portfolio-->
  <li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle {{ $page === 'portfolio' ? 'active' : '' }}" href="#" role="button"
  ...
  <!--begin:blog-->
  <li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle {{ $page === 'blog' ? 'active' : '' }}" href="#" role="button"
  ...
  <!--begin:pages-->
  <li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle {{ $page === 'pages' ? 'active' : '' }}" href="#" role="button"
  ...
  <!--end:navbar-items-left-->

  <!--begin:navbar-items-right-->
  <ul class="navbar-nav ms-lg-auto">
  <!--begin:components-->
  <li class="nav-item dropdown position-lg-static">
    <a class="nav-link dropdown-toggle {{ $page === 'components' ? 'active' : '' }}" href="#" role="button"
        ...
        <div class="col-lg-3">
          <div class="h-100">
            <div>
              ...
              <a class="dropdown-item" href="component-video-plyr.html">Video Player</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <!--begin:features-->
  <li class="nav-item dropdown position-lg-static">
    <a class="nav-link dropdown-toggle {{ $page === 'features' ? 'active' : '' }}" href="#" role="button"
        ...
        <div class="row mx-lg-0">
          <div class="col-lg-4 mb-4 mb-lg-0">
            ...
            <div class="row g-0">
              ...
              <div class="col-lg-6">
                ...
                <a href="header-search-bar-3.html" class="dropdown-item">Search 3 <span class="badge bg-success small ms-1">New</span></a>

                <a href="header-search-with-icons.html" class="dropdown-item">Icons <span class="badge bg-success small ms-1">New</span></a>
          ...
          <div class="col-lg-5 mb-4 mb-lg-0">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                ...
                <a href="hero-tiles.html" class="dropdown-item">Image tiles</a>
                <a href="hero-media-player.html" class="dropdown-item">Media Player <span class="badge bg-success small ms-1">New</span></a>
          ...
          <div class="col-lg-3">
            ...
            <h5 class="dropdown-header mb-lg-2">
              ...
              <a class="d-flex align-items-center dropdown-item" href="theme-style-rtl.html">
  ...
  <!--begin:demos-->
  <li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle  {{ $page === 'demos' ? 'active' : '' }}" href="#" role="button"
    ...
    <div class="dropdown-menu p-lg-3 dropdown-menu-end dropdown-menu-xs">
      ...
      <div class="dropdown-divider"></div>
      <a class="dropdown-item" target="_blank" href="https://uigator.com/assan/5.1/admin-dashboard/">
        Admin Dashboard
      </a>
      <a class="dropdown-item" target="_blank" href="https://uigator.com/assan/5.1/nft-marketplace/">
        NFT Marketplace
      </a>
      <a class="dropdown-item" target="_blank" href="https://uigator.com/assan/5.1/blog-magazine/">
      Blog Magazine
      </a>
      <!--footer-->
      <div class="p-3">
