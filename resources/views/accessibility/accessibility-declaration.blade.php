        ...
        <div class="container z-2 position-relative">
            <div class="row align-items-center vh-100">
                <div class="col-lg-11 pt-3 pb-4 pb-lg-5 pt-lg-5 me-auto col-md-11 z-2">
                    ...
                    -->
                    <p class="mt-5">
                        Diese Erklärung wurde am {{ $declaration->updated_at->format('d.m.Y') }} mit<a href="https://aktion-barrierefrei.org/produkte/barrierefreiheitserklaerung" target="_blank"><img style="width:3em;" src="{{ asset('assets/img/produkte/be.svg') }}" alt="be. barrierefreiheitserklärung"></a>  erstellt. Ein Service von <a href="https://aktion-barrierefrei.org" target="_blank" style="text-decoration:underline;" target="_blank">aktion-barrierefrei.org</a>. <span style="color:dark-grey">( Letzte Aktualisierung {{ $declaration->effective_last_checked->format('d.m.Y H:i') }} Uhr )</span>
                    </p>
