...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('acc_comp_declarations')) {
            Schema::create('acc_comp_declarations', function (Blueprint $table) {
                $table->id();
                ...
                $table->text('declaration_intro_text_ez'); // blah ist behmueht... in leichter Sprache
                $table->text('company_offer'); // <Firmenangebot>
                $table->text('company_offer_ez'); // <Firmenangebot> eztext
                ...
                $table->text('market_surveillance_board_address')->nullable(); // Marktueberwachungsbehoerde (adressse)
                $table->text('market_surveillance_board_address_text')->nullable(); // Marktueberwachungsbehoerde (adressse)
                $table->text('market_surveillance_board_address_text_ez')->nullable(); // Marktueberwachungsbehoerde (adressse) eztext
    ...
    {
        Schema::dropIfExists('acc_comp_declarations');
    }
};
